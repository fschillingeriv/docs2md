...
2. If the account has an @yourcompany.com email address that your company controls, you can use the [delete without logging in](https://bitwarden.com/help/delete-your-account/#delete-an-individual-account/) workflow and confirm deletion within the @yourcompany.com inbox.
