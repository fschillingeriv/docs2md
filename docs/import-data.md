...
If an item in your file (typically a `.csv`) exceeds a field’s **encrypted** character limit, Bitwarden will not import any of its contents. An “Import error” message will appear with details identifying the specific issue(s).
