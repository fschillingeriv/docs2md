...
> **If your customer uses directory service** or IdP (such as Active Directory, an LDAP, or Okta), use [SCIM](https://bitwarden.com/help/about-scim/) or [Directory Connector](https://bitwarden.com/help/directory-sync/) to automatically sync organization users from the source directory. Optional, turn on the **Automatically send email invitations** setting in [SCIM](https://bitwarden.com/help/about-scim/#invite-users-after-provisioning/) or [Directory Connector](https://bitwarden.com/help/user-group-filters/#automatically-send-email-invitations/) for quick user provisioning.
