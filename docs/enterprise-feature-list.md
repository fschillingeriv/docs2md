...
| Organization invite link | Generate shareable [organization invite links](https://bitwarden.com/help/managing-users/#tab-invite-by-link-1FpWqHUBGbhM3aGLCHtK6P/) that can be restricted to trusted domains and rotated for additional security. |
