---
URL: https://bitwarden.com/help/product-highlights-and-recent-updates/
---
...
Learn more: [Access Intelligence](https://bitwarden.com/help/access-intelligence/)
...
Learn more: [Enterprise policies](https://bitwarden.com/help/policies/#centralize-organization-ownership/)
...
Learn more: [Bitwarden sets foundation for secure AI authentication with MCP server](https://bitwarden.com/blog/bitwarden-mcp-server/)
...
Learn more: [Collection settings](https://bitwarden.com/help/collection-management/)
...
Learn more: [Enterprise policies](https://bitwarden.com/help/policies/)
...
Learn more: [Log in with passkeys](https://bitwarden.com/help/login-with-passkeys/)
...
Learn more: [Import directly from browser](https://bitwarden.com/help/import-from-chrome/#import-directly-from-browser/)
...
Learn more: [SSH Agent](https://bitwarden.com/help/ssh-agent/)
...
Learn more: [Approve a trusted device](https://bitwarden.com/help/approve-a-trusted-device/)
...
Learn more: [Claimed domains](https://bitwarden.com/help/claimed-domains/#claimed-member-accounts/)

> [!NOTE] See more
> For a full list of updates and features, visit the [Bitwarden release notes page](https://bitwarden.com/help/releasenotes/). For monthly updates about new features and security tips, subscribe to the [Bitwarden newsletter](https://bitwarden.com/newsletter-subscribe/).
