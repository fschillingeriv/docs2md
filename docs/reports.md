...
> If you are self-hosting Bitwarden, in order to run the data breach report in your instance you will need to buy a Have I Been Pwned subscription key that will authorize you to make calls to the API, obtained [here](https://haveibeenpwned.com/API/Key).
> 
